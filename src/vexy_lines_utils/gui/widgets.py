# this_file: src/vexy_lines_utils/gui/widgets.py
"""
CTkRangeSlider - Range slider widget for customtkinter.

Original author: Akash Bora (Version 0.3).
Bundled into vexy-lines-utils to avoid an external dependency.
"""
...
class CustomDrawEngine:
    """
    Custom version of the CustomTkinter DrawEngine core, tailored for the range slider.
    Handles all canvas drawing for the two-thumb slider widget.
    """
    ...
    def __draw_rounded_rect_with_border_font_shapes(
            ...
            if corner_radius > 0:
                if not self._canvas.find_withtag("border_oval_1_a") and "border_oval_1" not in exclude_parts:
                    self._canvas.create_aa_circle(
                        0, 0, 0, tags=("border_oval_1_a", "border_corner_part", "border_parts"), anchor=tk.CENTER
                    )
                    self._canvas.create_aa_circle(
                        0,
                        0,
                ...
                if (
                    ...
                    self._canvas.create_aa_circle(
                        0, 0, 0, tags=("border_oval_2_a", "border_corner_part", "border_parts"), anchor=tk.CENTER
                    )
                    self._canvas.create_aa_circle(
                        0,
                        0,
                ...
                if (
                    ...
                    self._canvas.create_aa_circle(
                        0, 0, 0, tags=("border_oval_3_a", "border_corner_part", "border_parts"), anchor=tk.CENTER
                    )
                    self._canvas.create_aa_circle(
                        0,
                        0,
                    ...
                    not (height > 2 * corner_radius and width > 2 * corner_radius) or "border_oval_3" in exclude_parts
                ):
                ...
                if (
                    ...
                    self._canvas.create_aa_circle(
                        0, 0, 0, tags=("border_oval_4_a", "border_corner_part", "border_parts"), anchor=tk.CENTER
                    )
                    self._canvas.create_aa_circle(
                        0,
                        0,
        ...
        if inner_corner_radius > 0:
            if not self._canvas.find_withtag("inner_oval_1_a") and "inner_oval_1" not in exclude_parts:
                self._canvas.create_aa_circle(
                    0, 0, 0, tags=("inner_oval_1_a", "inner_corner_part", "inner_parts"), anchor=tk.CENTER
                )
                self._canvas.create_aa_circle(
                    0, 0, 0, tags=("inner_oval_1_b", "inner_corner_part", "inner_parts"), anchor=tk.CENTER, angle=180
                )
                requires_recoloring = True
            ...
            if (
                ...
                self._canvas.create_aa_circle(
                    0, 0, 0, tags=("inner_oval_2_a", "inner_corner_part", "inner_parts"), anchor=tk.CENTER
                )
                self._canvas.create_aa_circle(
                    0, 0, 0, tags=("inner_oval_2_b", "inner_corner_part", "inner_parts"), anchor=tk.CENTER, angle=180
                )
                requires_recoloring = True
            ...
            if (
                ...
                self._canvas.create_aa_circle(
                    0, 0, 0, tags=("inner_oval_3_a", "inner_corner_part", "inner_parts"), anchor=tk.CENTER
                )
                self._canvas.create_aa_circle(
                    0, 0, 0, tags=("inner_oval_3_b", "inner_corner_part", "inner_parts"), anchor=tk.CENTER, angle=180
                )
                requires_recoloring = True
            ...
            if (
                ...
                self._canvas.create_aa_circle(
                    0, 0, 0, tags=("inner_oval_4_a", "inner_corner_part", "inner_parts"), anchor=tk.CENTER
                )
                self._canvas.create_aa_circle(
                    0, 0, 0, tags=("inner_oval_4_b", "inner_corner_part", "inner_parts"), anchor=tk.CENTER, angle=180
                )
                requires_recoloring = True
    ...
    def __draw_rounded_rect_with_border_circle_shapes(
        ...
        if border_width > 0:
            if corner_radius > 0:
                ...
                self._canvas.coords(
                    "border_oval_3", width - 2 * corner_radius, height - 2 * corner_radius, width, height
                )
        ...
        if inner_corner_radius > 0:
            ...
            self._canvas.coords(
                "inner_oval_2",
                width - border_width - 2 * inner_corner_radius,
                border_width,
                width - border_width,
                border_width + 2 * inner_corner_radius,
            )
            self._canvas.coords(
                "inner_oval_3",
                width - border_width - 2 * inner_corner_radius,
                height - border_width - 2 * inner_corner_radius,
                width - border_width,
                height - border_width,
            )
            self._canvas.coords(
    ...
    def __draw_rounded_progress_bar_with_border_polygon_shapes(
        self,
        width: int,
        height: int,
        corner_radius: int,
        ...
        requires_recoloring = self.__draw_rounded_rect_with_border_polygon_shapes(
            width, height, corner_radius, border_width, inner_corner_radius
        )

        bottom_right_shift = 0 if corner_radius <= border_width else 0
        ...
        if orientation == "w":
            ...
            self._canvas.coords(
                ...
                border_width
                + inner_corner_radius
                + (height - 2 * border_width - 2 * inner_corner_radius) * (1 - progress_value_2),
                width - (border_width + inner_corner_radius),
                border_width
                + inner_corner_radius
                + (height - 2 * border_width - 2 * inner_corner_radius) * (1 - progress_value_2),
                ...
                border_width
                + inner_corner_radius
                + (height - 2 * border_width - 2 * inner_corner_radius) * (1 - progress_value_1),
                border_width + inner_corner_radius,
                border_width
                + inner_corner_radius
                + (height - 2 * border_width - 2 * inner_corner_radius) * (1 - progress_value_1),
    ...
    # ── font_shapes progress bar ───────────────────────────────────────

    def __draw_rounded_progress_bar_with_border_font_shapes(
        self,
        width: int,
        height: int,
        corner_radius: int,
        ...
        if inner_corner_radius > 0:
            if not self._canvas.find_withtag("progress_oval_1_a"):
                self._canvas.create_aa_circle(
                    0, 0, 0, tags=("progress_oval_1_a", "progress_corner_part", "progress_parts"), anchor=tk.CENTER
                )
                self._canvas.create_aa_circle(
                    0,
                    0,
                ...
                self._canvas.create_aa_circle(
                    0, 0, 0, tags=("progress_oval_2_a", "progress_corner_part", "progress_parts"), anchor=tk.CENTER
                )
                self._canvas.create_aa_circle(
                    0,
                    0,
            ...
            if (
                not self._canvas.find_withtag("progress_oval_3_a")
                and (inner_corner_radius) * 2 < height - 2 * border_width
            ):
                self._canvas.create_aa_circle(
                    0, 0, 0, tags=("progress_oval_3_a", "progress_corner_part", "progress_parts"), anchor=tk.CENTER
                )
                self._canvas.create_aa_circle(
                    0,
                    0,
                ...
                self._canvas.create_aa_circle(
                    0, 0, 0, tags=("progress_oval_4_a", "progress_corner_part", "progress_parts"), anchor=tk.CENTER
                )
                self._canvas.create_aa_circle(
                    0,
                    0,
                ...
                self._canvas.find_withtag("progress_oval_3_a")
                and not (inner_corner_radius) * 2 < height - 2 * border_width
            ):
        ...
        if orientation == "w":
            requires_recoloring_2 = self.__draw_rounded_rect_with_border_font_shapes(
                width,
                height,
                corner_radius,
                border_width,
    ...
    def __draw_rounded_progress_bar_with_border_circle_shapes(
        self,
        width: int,
        height: int,
        corner_radius: int,
        ...
        requires_recoloring = self.__draw_rounded_rect_with_border_circle_shapes(
            width, height, corner_radius, border_width, inner_corner_radius
        )
    ...
    def __draw_rounded_slider_with_border_and_2_button_polygon_shapes(
        ...
        requires_recoloring = self.__draw_rounded_progress_bar_with_border_polygon_shapes(
            width,
            height,
            corner_radius,
            border_width,
        ...
        if corner_radius <= border_width:
            ...
            bottom_right_shift = 0  # noqa: F841

        if orientation == "w":
            slider_x_position = (
                corner_radius + (button_length / 2) + (width - 2 * corner_radius - button_length) * slider_value
            )
            self._canvas.coords(
                "slider_line_1",
            ...
            slider_x_position = (
                corner_radius + (button_length / 2) + (width - 2 * corner_radius - button_length) * slider_2_value
            )
            self._canvas.coords(
                "slider_2_line_1",
                slider_x_position - (button_length / 2),
            ...
            slider_y_position = (
                corner_radius + (button_length / 2) + (height - 2 * corner_radius - button_length) * (1 - slider_value)
            )
            self._canvas.coords(
                "slider_line_1",
                button_corner_radius,
    ...
    def __draw_rounded_slider_with_border_and_2_button_font_shapes(
        ...
        # first button - 4 circles
        if not self._canvas.find_withtag("slider_oval_1_a"):
            self._canvas.create_aa_circle(
                0,
                0,
                0,
                tags=("slider_oval_1_a", "slider_corner_part", "slider_parts", "slider_0_parts"),
                anchor=tk.CENTER,
            )
            self._canvas.create_aa_circle(
                0,
                0,
                0,
                tags=("slider_oval_1_b", "slider_corner_part", "slider_parts", "slider_0_parts"),
                anchor=tk.CENTER,
                angle=180,
            )
            requires_recoloring = True
        ...
        if not self._canvas.find_withtag("slider_oval_2_a") and button_length > 0:
            self._canvas.create_aa_circle(
                ...
                0,
                0,
                tags=("slider_oval_2_a", "slider_corner_part", "slider_parts", "slider_0_parts"),
                anchor=tk.CENTER,
            )
            self._canvas.create_aa_circle(
                0,
                0,
                0,
                tags=("slider_oval_2_b", "slider_corner_part", "slider_parts", "slider_0_parts"),
                anchor=tk.CENTER,
                angle=180,
            )
            requires_recoloring = True
        ...
        if not self._canvas.find_withtag("slider_oval_4_a") and height > 2 * button_corner_radius:
            self._canvas.create_aa_circle(
                ...
                0,
                0,
                tags=("slider_oval_4_a", "slider_corner_part", "slider_parts", "slider_0_parts"),
                anchor=tk.CENTER,
            )
            self._canvas.create_aa_circle(
                0,
                0,
                0,
                tags=("slider_oval_4_b", "slider_corner_part", "slider_parts", "slider_0_parts"),
                anchor=tk.CENTER,
                angle=180,
            )
            requires_recoloring = True
        ...
        if not self._canvas.find_withtag("slider_oval_3_a") and button_length > 0 and height > 2 * button_corner_radius:
            self._canvas.create_aa_circle(
                ...
                0,
                0,
                tags=("slider_oval_3_a", "slider_corner_part", "slider_parts", "slider_0_parts"),
                anchor=tk.CENTER,
            )
            self._canvas.create_aa_circle(
                0,
                0,
                0,
                tags=("slider_oval_3_b", "slider_corner_part", "slider_parts", "slider_0_parts"),
                anchor=tk.CENTER,
                angle=180,
            )
            requires_recoloring = True
        elif self._canvas.find_withtag("slider_oval_3_a") and not (
            button_length > 0 and height > 2 * button_corner_radius
        ):
            self._canvas.delete("slider_oval_3_a", "slider_oval_3_b")

        # first button - rectangles
        if not self._canvas.find_withtag("slider_rectangle_1") and button_length > 0:
            self._canvas.create_rectangle(
                ...
                0,
                0,
                tags=("slider_rectangle_1", "slider_rectangle_part", "slider_parts", "slider_0_parts"),
                width=0,
            )
            requires_recoloring = True
        ...
        if not self._canvas.find_withtag("slider_rectangle_2") and height > 2 * button_corner_radius:
            self._canvas.create_rectangle(
                ...
                0,
                0,
                tags=("slider_rectangle_2", "slider_rectangle_part", "slider_parts", "slider_0_parts"),
                width=0,
            )
            requires_recoloring = True
        ...
        if orientation == "w":
            ...
            self._canvas.coords(
                "slider_oval_1_a", slider_x_position - (button_length / 2), button_corner_radius, button_corner_radius
            )
            self._canvas.coords(
                "slider_oval_1_b", slider_x_position - (button_length / 2), button_corner_radius, button_corner_radius
            )
            self._canvas.coords(
                "slider_oval_2_a", slider_x_position + (button_length / 2), button_corner_radius, button_corner_radius
            )
            self._canvas.coords(
                "slider_oval_2_b", slider_x_position + (button_length / 2), button_corner_radius, button_corner_radius
            )
            self._canvas.coords(
                "slider_oval_3_a",
                slider_x_position + (button_length / 2),
            ...
            self._canvas.coords(
                "slider_oval_1_a", button_corner_radius, slider_y_position - (button_length / 2), button_corner_radius
            )
            self._canvas.coords(
                "slider_oval_1_b", button_corner_radius, slider_y_position - (button_length / 2), button_corner_radius
            )
            self._canvas.coords(
                "slider_oval_2_a", button_corner_radius, slider_y_position + (button_length / 2), button_corner_radius
            )
            self._canvas.coords(
                "slider_oval_2_b", button_corner_radius, slider_y_position + (button_length / 2), button_corner_radius
            )
            self._canvas.coords(
                "slider_oval_3_a",
                width - button_corner_radius,
        ...
        # second button - 4 circles
        if not self._canvas.find_withtag("slider_oval_2_1_a"):
            self._canvas.create_aa_circle(
                0,
                0,
                0,
                tags=("slider_oval_2_1_a", "slider_corner_part", "slider_parts", "slider_1_parts"),
                anchor=tk.CENTER,
            )
            self._canvas.create_aa_circle(
                0,
                0,
                0,
                tags=("slider_oval_2_1_b", "slider_corner_part", "slider_parts", "slider_1_parts"),
                anchor=tk.CENTER,
                angle=180,
            )
            requires_recoloring = True
        ...
        if not self._canvas.find_withtag("slider_oval_2_2_a") and button_length > 0:
            self._canvas.create_aa_circle(
                ...
                0,
                0,
                tags=("slider_oval_2_2_a", "slider_corner_part", "slider_parts", "slider_1_parts"),
                anchor=tk.CENTER,
            )
            self._canvas.create_aa_circle(
                0,
                0,
                0,
                tags=("slider_oval_2_2_b", "slider_corner_part", "slider_parts", "slider_1_parts"),
                anchor=tk.CENTER,
                angle=180,
            )
            requires_recoloring = True
        ...
        if not self._canvas.find_withtag("slider_oval_2_4_a") and height > 2 * button_corner_radius:
            self._canvas.create_aa_circle(
                ...
                0,
                0,
                tags=("slider_oval_2_4_a", "slider_corner_part", "slider_parts", "slider_1_parts"),
                anchor=tk.CENTER,
            )
            self._canvas.create_aa_circle(
                0,
                0,
                0,
                tags=("slider_oval_2_4_b", "slider_corner_part", "slider_parts", "slider_1_parts"),
                anchor=tk.CENTER,
                angle=180,
            )
            requires_recoloring = True
        ...
        if (
            ...
            self._canvas.create_aa_circle(
                ...
                0,
                0,
                tags=("slider_oval_2_3_a", "slider_corner_part", "slider_parts", "slider_1_parts"),
                anchor=tk.CENTER,
            )
            self._canvas.create_aa_circle(
                0,
                0,
                0,
                tags=("slider_oval_2_3_b", "slider_corner_part", "slider_parts", "slider_1_parts"),
                anchor=tk.CENTER,
                angle=180,
            )
            requires_recoloring = True
        elif self._canvas.find_withtag("slider_oval_2_3_a") and not (
            button_length > 0 and height > 2 * button_corner_radius
        ):
            self._canvas.delete("slider_oval_2_3_a", "slider_oval_2_3_b")

        # second button - rectangles
        if not self._canvas.find_withtag("slider_rectangle_2_1") and button_length > 0:
            self._canvas.create_rectangle(
                ...
                0,
                0,
                tags=("slider_rectangle_2_1", "slider_rectangle_part", "slider_parts", "slider_1_parts"),
                width=0,
            )
            requires_recoloring = True
        ...
        if not self._canvas.find_withtag("slider_rectangle_2_2") and height > 2 * button_corner_radius:
            self._canvas.create_rectangle(
                ...
                0,
                0,
                tags=("slider_rectangle_2_2", "slider_rectangle_part", "slider_parts", "slider_1_parts"),
                width=0,
            )
            requires_recoloring = True
        ...
        if orientation == "w":
            ...
            self._canvas.coords(
                "slider_oval_2_1_a", slider_x_position - (button_length / 2), button_corner_radius, button_corner_radius
            )
            self._canvas.coords(
                "slider_oval_2_1_b", slider_x_position - (button_length / 2), button_corner_radius, button_corner_radius
            )
            self._canvas.coords(
                "slider_oval_2_2_a", slider_x_position + (button_length / 2), button_corner_radius, button_corner_radius
            )
            self._canvas.coords(
                "slider_oval_2_2_b", slider_x_position + (button_length / 2), button_corner_radius, button_corner_radius
            )
            self._canvas.coords(
                "slider_oval_2_3_a",
                slider_x_position + (button_length / 2),
            ...
            self._canvas.coords(
                "slider_oval_2_1_a", button_corner_radius, slider_y_position - (button_length / 2), button_corner_radius
            )
            self._canvas.coords(
                "slider_oval_2_1_b", button_corner_radius, slider_y_position - (button_length / 2), button_corner_radius
            )
            self._canvas.coords(
                "slider_oval_2_2_a", button_corner_radius, slider_y_position + (button_length / 2), button_corner_radius
            )
            self._canvas.coords(
                "slider_oval_2_2_b", button_corner_radius, slider_y_position + (button_length / 2), button_corner_radius
            )
            self._canvas.coords(
                "slider_oval_2_3_a",
                width - button_corner_radius,
    ...
    def __draw_rounded_slider_with_border_and_2_button_circle_shapes(
        self,
        width: int,
        height: int,
        corner_radius: int,
        ...
        requires_recoloring = self.__draw_rounded_progress_bar_with_border_circle_shapes(
            width,
            height,
            corner_radius,
            border_width,
        ...
        if not self._canvas.find_withtag("slider_0_parts"):
            ...
            self._canvas.create_rectangle(
                0, 0, 0, 0, tags=("slider_rectangle_1", "slider_parts", "slider_0_parts"), width=0
            )
            self._canvas.create_rectangle(
                0, 0, 0, 0, tags=("slider_rectangle_2", "slider_parts", "slider_0_parts"), width=0
            )
            requires_recoloring = True
        ...
        if not self._canvas.find_withtag("slider_1_parts"):
            ...
            self._canvas.create_rectangle(
                0, 0, 0, 0, tags=("slider_rectangle_2_1", "slider_parts", "slider_1_parts"), width=0
            )
            self._canvas.create_rectangle(
                0, 0, 0, 0, tags=("slider_rectangle_2_2", "slider_parts", "slider_1_parts"), width=0
            )
            requires_recoloring = True
...
class CTkRangeSlider(CTkBaseClass):
    """
    Range slider with two thumbs, rounded corners, border, number of steps,
    variable support, and vertical orientation.
    """
    ...
    def __init__(
        ...
        **kwargs: object,
        ...
        # callbacks and control variables
    ...
    def _draw(self, no_color_updates: bool = False) -> None:
        ...
        if no_color_updates is False or requires_recoloring:
            ...
            if self._hover_states[0] and self._hover:
                self._canvas.itemconfig(
                    "slider_0_parts",
            ...
            if self._hover_states[1] and self._hover:
                self._canvas.itemconfig(
                    "slider_1_parts",
                    fill=self._apply_appearance_mode(self._button_hover_color),
                    outline=self._apply_appearance_mode(self._button_hover_color),
    ...
    def _on_enter(self, event: object = None) -> None:
        ...
        if self._orientation.lower() == "horizontal":
            enter_pos = self._reverse_widget_scaling(event.x / self._current_width)
            if enter_pos < self._values[0] or abs(enter_pos - self._values[0]) <= abs(enter_pos - self._values[1]):
                highlight_tag = "slider_0_parts"
                normal_tag = "slider_1_parts"
                color = self._button_color_1
                self._hover_states = (True, False)
                self._active_slider = True
            else:
                highlight_tag = "slider_1_parts"
                normal_tag = "slider_0_parts"
                color = self._button_color_0
                self._hover_states = (False, True)
                self._active_slider = False
        else:
            enter_pos = 1 - self._reverse_widget_scaling(event.y / self._current_height)
            if enter_pos < self._values[0] or abs(enter_pos - self._values[0]) <= abs(enter_pos - self._values[1]):
                highlight_tag = "slider_0_parts"
                normal_tag = "slider_1_parts"
                color = self._button_color_1
        ...
        self._canvas.itemconfig(
            normal_tag, fill=self._apply_appearance_mode(color), outline=self._apply_appearance_mode(color)
        )
    ...
    def _round_to_step_size(self, values: float | list[float]) -> float | list[float]:
    ...
    def unbind(self, sequence: str | None = None, funcid: str | None = None) -> None:
        if funcid is not None:
            msg = "'funcid' argument can only be None, because there is a bug in tkinter and it's not clear whether the internal callbacks will be unbound or not"
            raise ValueError(msg)
    ...
    def cget(self, attribute_name: str) -> object:
        ...
        if attribute_name == "button_corner_radius":
            return self._button_corner_radius
        if attribute_name == "border_width":
            return self._border_width
        if attribute_name == "button_length":
        ...
        if attribute_name == "button_color":
            return self._button_color_0
        if attribute_name == "button_hover_color":
            return self._button_hover_color
        if attribute_name == "from_":
            return self._from_
        if attribute_name == "to":
            return self._to
        if attribute_name == "state":
            return self._state
        if attribute_name == "number_of_steps":
            return self._number_of_steps
        if attribute_name == "hover":
            return self._hover
        if attribute_name == "command":
            return self._command
        if attribute_name == "variables":
